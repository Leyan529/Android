...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_DATA_UPDATE_ANS = "extra_ans_to_be_updated";
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == NEW_WORD_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            Word word = new Word(data.getStringExtra(NewWordActivity.EXTRA_REPLY),
                    data.getStringExtra(NewWordActivity.EXTRA_ANS));
            // Save the data
            mWordViewModel.insert(word);
        } else if (requestCode == UPDATE_WORD_ACTIVITY_REQUEST_CODE
                && resultCode == RESULT_OK) {
            Toast.makeText(
                    this, "Update", Toast.LENGTH_LONG).show();
            Word newword = new Word(data.getStringExtra(NewWordActivity.EXTRA_REPLY),
                    data.getStringExtra(NewWordActivity.EXTRA_ANS));
            Word word = new Word(data.getStringExtra(NewWordActivity.ORIGN_WORD),
                    data.getStringExtra(NewWordActivity.ORIGN_ANS));
            mWordViewModel.updateWords(word,newword);
    ...
    public void launchUpdateWordActivity( Word word) {
        ...
        intent.putExtra(EXTRA_DATA_UPDATE_ANS, word.getAns());
