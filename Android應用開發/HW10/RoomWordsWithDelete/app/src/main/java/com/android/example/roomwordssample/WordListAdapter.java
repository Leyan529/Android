...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.WordViewHolder> {
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        if (mWords != null) {
            ...
            holder.wordItemAnsView.setText(current.getAns());

        } else {
            // Covers the case of data not being ready yet.
            // holder.wordItemView.setText("No Word");
            holder.wordItemView.setText(R.string.no_word);
            holder.wordItemAnsView.setText(R.string.no_word);
        }
    }
    ...
    */
    ...
    class WordViewHolder extends RecyclerView.ViewHolder {
        private final TextView wordItemView,wordItemAnsView;
        ...
        private WordViewHolder(View itemView) {
            ...
            wordItemAnsView = itemView.findViewById(R.id.textView_Ans);
        }
    }
