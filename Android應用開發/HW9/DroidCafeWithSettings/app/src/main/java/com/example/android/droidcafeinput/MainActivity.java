...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] delivery_array = getResources().getStringArray(R.array.delivery_keys);
        String deliveryPref = sharedPref
                .getString("delivery_list", "0");
        int delivery_val = Integer.valueOf(deliveryPref);
        displayToast(marketPref + ", " + delivery_array[delivery_val]);
    }
